...
**Edits made by me to this setup and start template for using Laravel's Vue Starter Kit:**

> This coming from the Laravel Docker Example Project:

In `docker/development/workspace/Dockerfile`:

- `procps \`
- `&& docker-php-ext-configure pcntl --enable-pcntl \`
- `pcntl \` (those 3 for having [Laravel Pail](https://github.com/laravel/pail))

> This coming from the Laravel + Vue Starter Kit:

In `composer.json`:

- `"bash -c '. ~/.nvm/nvm.sh && ... '` (to have npx available there, it wouldn't be available otherwise)
...
(making Laravel work with Vite in a Docker setup, with Hot Module Reloading, [see here for example](https://laracasts.com/discuss/channels/vite/using-laravel-10-vite-and-docker))
